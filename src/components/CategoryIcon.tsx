...
const CATEGORY_CONFIG: Record<Category, { icon: string; color: string; bg: string }> = {
  ...
  shopping: { icon: 'bag-handle', color: '#F97316', bg: '#FFF7ED' },
  health: { icon: 'medkit', color: '#EF4444', bg: '#FEF2F2' },
  travel: { icon: 'airplane', color: '#0EA5E9', bg: '#F0F9FF' },
  education: { icon: 'school', color: '#8B5CF6', bg: '#F5F3FF' },
  subscriptions: { icon: 'card', color: '#6366F1', bg: '#EEF2FF' },
  gifts: { icon: 'gift', color: '#EC4899', bg: '#FDF2F8' },
  pets: { icon: 'paw', color: '#A16207', bg: '#FFFBEB' },
  fitness: { icon: 'barbell', color: '#14B8A6', bg: '#F0FDFA' },
  sports: { icon: 'tennisball', color: '#10B981', bg: '#ECFDF5' },
