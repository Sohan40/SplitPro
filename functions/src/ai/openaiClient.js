  ...
  if (process.env.SPLITPRO_MOCK_OPENAI === "true") {
    return {
      outputText: JSON.stringify({
        ...
        unusualPatterns: [],
        memberInsights: [],
        budgetSuggestions: ["Use deterministic totals as the source of truth for any budget target."],
        settlementSuggestions: [],
        nextActions: ["Run this flow with real group data after entitlement is active."],
